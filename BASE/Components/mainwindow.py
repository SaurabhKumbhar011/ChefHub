...
class MainWindow(tk.Tk):
    def __init__(self) -> object:
        ...
        self.iconphoto(True, tk.PhotoImage(file='D:\\RestaurantManagementSystemV0.1.1\\assets\\icon_m.png'))
        ...
        self.img = Image.open("D:\\RestaurantManagementSystemV0.1.1\\assets\\ChefHub2.png")
        self.img = self.img.resize((400, 265), Image.Resampling.LANCZOS)
        self.img = ImageTk.PhotoImage(self.img)
        self.panel = tk.Label(self.m_frame, image=self.img, text="Restaurant Management System", compound='top',
